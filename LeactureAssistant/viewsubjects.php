...
$count = mysql_query("SELECT * FROM  subjects");
...
$sql ="SELECT * FROM  subjects   LIMIT $row_start, $per_page";
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<center>  <a href="addsubject.php"> <font color="white"> Add Subject </font> </a>  </center>
				</div>
						...
						<table class="table table-striped table-bordered table-hover"
							...
							<?php $sno=1;$i = $row_start; while($row = mysql_fetch_assoc($result))  {  $i++;?>
								...
								<tr>
									...
									<td><a
										href="deletesubject.php?subjectid=<?php echo $row ['subjectid']; ?>" />Delete
										</a></td>
							...
							if ($total_rows == 0) {
								echo '<tr><td colspan="3">No records found to display.</td></tr>';
							}
							?>
							</tbody>
						</table>
