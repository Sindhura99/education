...
$count = mysql_query("SELECT * FROM  faculty");
...
$sql ="SELECT * FROM  faculty   LIMIT $row_start, $per_page";
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<center>  <a href="addfaculty.php"> <font color="white"> Add Faculty </font> </a>  </center>
				</div>
						...
						<table class="table table-striped table-bordered table-hover"
							...
							<?php $sno=1;$i = $row_start; while($row = mysql_fetch_assoc($result))  {  $i++;?>
								...
								<tr>
									...
									<td><a
										href="editfaculty.php?facultyid=<?php echo $row ['facultyid']; ?>" />Update
										</a></td>
									<td><a
										href="deletefaculty.php?username=<?php echo $row ['facultyid']; ?>" />Delete
										</a></td>
