...
<body>
	...
	<div class="wrap">
		<div class="navigation-strip">
			...
			<div class="top-menu">
				<ul class="megamenu skyblue">
					<li><a href="viewmyclassstudents.php">Students</a></li>
					<li><a href="viewclassattendance.php">View Attendance</a></li>
					<li><a href="addattendance.php">Add Attendance</a>
					<li><a href="viewdocuments.php">View Documents</a>
					<li><a href="viewtest.php">Exam's</a></li>
					<li><a href="logout.php">Logout</a></li>
				</ul>
			</div>
